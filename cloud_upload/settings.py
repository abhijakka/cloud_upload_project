"""
Django settings for cloud_upload project.
...
SECRET_KEY = 'django-insecure-99wb^l_00yl*n2(20dk3qsrqacai3amjqut%ai9^h9hidsh6qs'
...
ROOT_URLCONF = 'cloud_upload.urls'
...
WSGI_APPLICATION = 'cloud_upload.wsgi.application'
